...
export default function ProductPage({
  ...
  // 2. Client side par data fetch kar rahe hain jaise home page par kiya
  useEffect(() => {
  ...
  // 3. Aapke wahi custom functions jo aapko chahiye the
  ...
  // 💬 Comment Submit Handling (Option 2 - Secure Backend Cookies)
  ...
  return (
    <>
      <div className="container py-5">
        ...
        {/* ======================================================== */}
        {/* 💬 REVIEWS & COMMENTS SECTION BLOCK                      */}
        {/* ======================================================== */}
